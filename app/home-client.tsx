...
export default function HomePage() {
  return (
    <div className="flex flex-col bg-[#F4F0FF]">
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-4 max-w-2xl mx-auto">
              ...
              From real-time data intelligence to advanced security solutions.
            </p>

            <p className="text-base text-muted-foreground mb-8 max-w-2xl mx-auto font-medium">
              Explore our suite of products:
              <span className="text-blue-600 font-bold"> Segmento Pulse</span> for intelligent news & insights, and
      ...
      {/* Products Section (ANCHOR TARGET) */}
      <section
        id="products"
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-6xl mx-auto">
            ...
            >
              <div className="flex flex-col h-full">
                ...
                <Link href="/pulse">
                  <Button size="lg" className="w-full bg-linear-to-r from-blue-600 to-purple-600">
            ...
            >
              <div className="flex flex-col h-full">
                ...
                <p className="text-lg text-muted-foreground mb-6">
                  ...
                  the highest levels of intelligence and security.
                </p>
