...
export function EnterpriseSection() {
    return (
        <section
            id="enterprise"
            className="py-16 bg-white dark:bg-[#111827] overflow-hidden transition-colors duration-300"
        >
            <div className="container mx-auto px-4 max-w-7xl">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                    ...
                    >
                        <h2 className="text-4xl md:text-6xl font-black mb-6 text-slate-950 dark:text-white tracking-[-0.05em] leading-[0.95]">
                            Built for Scale <br />
                            ...
                            > 
                                <button
                                    className="
                                        ...
                                        text-white px-8 h-14 rounded-xl
                                        text-sm font-black
                                        shadow-xl shadow-indigo-100 dark:shadow-indigo-950/40
                        ...
                        <div className="pt-8 border-t border-slate-100 dark:border-slate-700">
                            <p className="text-[9px] font-black uppercase tracking-[0.3em] text-slate-400 dark:text-slate-500 mb-4">
                            ...
                            <div className="flex flex-wrap gap-2">
                                {["SOC 2 TYPE II", "HIPAA", "ISO 27001", "GDPR"].map((badge, i) => (
                                    <motion.span 
                                        ...
                                        key={badge}
                                        className="
                                            text-[9px] font-black px-3 py-1.5 rounded-lg
                            ...
                            return (
                                <motion.div
                                    ...
                                    className="
                                        ...
                                        hover:shadow-[0_20px_40px_-15px_rgba(99,102,241,0.1)]
                                ...
                                >
                                    ...
                                    <h3 className="text-lg font-bold text-slate-950 dark:text-white mb-2 tracking-tight transition-colors">
                                        {feature.title}
                                    </h3>
                                    
                                    <p className="text-xs text-slate-500 dark:text-slate-400 leading-normal font-medium mb-4 opacity-80 group-hover:opacity-100">
                                        {feature.description}
                                    </p>
