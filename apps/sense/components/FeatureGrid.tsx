...
export function FeatureGrid() {
    return (
        <section
            id="features"
            className="py-40 bg-[#FCFCFF] dark:bg-[#111827] overflow-hidden transition-colors duration-300"
        >
            <div className="container mx-auto px-4 max-w-7xl">
                ...
                <div className="mb-28 text-center">
                    ...
                    >
                        ...
                        <span className="text-[10px] font-black text-slate-400 dark:text-slate-500 uppercase tracking-[0.5em]">
                            System Capabilities
                        </span>
                    </motion.div>
                    ...
                    <motion.h2 
                        ...
                        whileInView={{ opacity: 1, y: 0 }}
                        className="text-5xl md:text-7xl font-black text-slate-950 dark:text-white tracking-[-0.06em] leading-none"
                    >
                        All-in-one{" "}
                    ...
                    <motion.p 
                        ...
                        className="mt-8 text-slate-500 dark:text-slate-400 font-medium text-sm md:text-base tracking-tight max-w-xl mx-auto"
                    >
                            ...
                            >
                                <div
                                    className="
                                        ...
                                        hover:shadow-[0_80px_100px_-30px_rgba(0,0,0,0.06)]
                                        dark:hover:shadow-[0_80px_100px_-30px_rgba(0,0,0,0.5)]
                                        hover:-translate-y-4
                                ...
                                >
                                    ...
                                    <div className="space-y-4">
                                        <h3 className="text-2xl font-bold text-slate-950 dark:text-white tracking-tight leading-none">
                                            {feature.title}
                                        </h3>
                                    ...
                                    <div className="mt-16 flex items-center justify-between">
                                        ...
                                        <Plus
                                            className="
                                                w-4 h-4
                                                text-slate-100 dark:text-slate-600
                                                group-hover:text-slate-950 dark:group-hover:text-white
