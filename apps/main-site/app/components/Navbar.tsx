        ...
        <div ref={containerRef} className="max-w-7xl mx-auto px-6" style={{ position: "relative" }}>
          <div className="flex items-center justify-between h-14">
            ...
            <Link href="/" className="flex items-center shrink-0 relative w-[180px] h-[28px]">
              <Image src="/images/logo-final.png"  alt="Segmento" width={180} height={28} priority className="logo-light" />
              <Image src="/images/logo-final1.png" alt="Segmento" width={180} height={28} priority className="logo-dark"  />
            </Link>
