        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            ...
            <p className="text-[18px] lg:text-[20px] text-slate-500 mb-10 max-w-lg leading-relaxed font-medium">
              Segmento delivers cutting-edge AI enabled Data products that solve real enterprise challenges. From real-time data intelligence to advanced security solutions for global organizations.
            </p>
