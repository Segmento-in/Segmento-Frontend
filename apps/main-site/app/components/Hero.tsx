...
export default function Hero() {
  ...
  return (
    <section className="relative flex items-center overflow-hidden hero-gradient-light" style={{ minHeight: '100vh', paddingTop: '10rem', paddingBottom: '8rem' }}>
      ...
      <div className="section-container w-full relative z-10">
        <div className="bento-grid items-center">
          ...
          <div className="col-span-12 lg:col-span-6 flex flex-col gap-6">
            ...
            <motion.div className="flex flex-wrap gap-3" {...fadeUp(0.28)}>
              <Link href="/contact" className="btn-primary group relative overflow-hidden">
                <span className="relative z-10 flex items-center gap-2">Book a Demo <ArrowRight size={15} className="group-hover:translate-x-1 transition-transform duration-300" /></span>
          ...
          <motion.div
            className="col-span-12 lg:col-span-6 hidden lg:flex items-center justify-center"
            initial={{ opacity: 0, scale: 0.95, y: 24 }} animate={{ opacity: 1, scale: 1, y: 0 }}
            transition={{ duration: 1.2, delay: 0.1, ease: [0.22, 1, 0.36, 1] }}
          >
            {/* Double Bezel Outer Shell */}
            <div className="w-full p-2 rounded-[2.25rem] bg-black/5 ring-1 ring-black/5 dark:bg-white/5 dark:ring-white/10 shadow-2xl relative">
