...
const LinkedinIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512" className="w-6 h-6 hover:scale-110 transition-transform">
        <path
                    ...
                    >
                        {team.map((member) => (
                            <motion.div
                                ...
                                variants={fadeInUp}
                                whileHover={{ y: -5 }}
                                className="bg-white rounded-2xl border border-purple-900 shadow-lg p-6 transition-shadow hover:shadow-2xl"
                            >
                    ...
                    >
                        {missions.map((mission) => (
                            <motion.div
                                ...
                                className="bg-white rounded-2xl border-2 border-purple-400 shadow-lg p-8 transition-all duration-300"
                            >
                                <motion.div
                                    initial={{ scale: 0 }}
                                    whileInView={{ scale: 1 }}
                ...
                <div className="container mx-auto px-4 text-center">
                    ...
                    >
                        ...
                        <div className="flex flex-col sm:flex-row gap-4 justify-center">
                            ...
                            <motion.div whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}>
                                <Link href="/careers">
                                    <button className="px-8 py-3 border-2 border-purple-600 text-purple-600 rounded-lg font-semibold hover:bg-purple-50 transition-colors shadow-lg">
                                        View Careers
                                    </button>
                                </Link>
                            </motion.div>
