          ...
          >
            ...
            <div className="relative w-full md:w-80">
              <input 
                ...
                className="w-full pl-12 pr-4 py-4 bg-sky-50 border-2 border-rounded border-[#0F172A] uppercase tracking-widest text-[10px] outline-none transition-all focus:bg-white"
              />
