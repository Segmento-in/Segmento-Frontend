...
import { ArticlesByTopic } from "@/components/organisms/ArticlesByTopic";
                            ...
                            {videos.map((vid) => (
                                ...
                                >
                                    ...
                                    <div style={{ padding: "16px 20px" }}>
                                        ...
                                        <span style={{ fontSize: "13px", color: "var(--pulse-color-text-secondary)", fontWeight: 500 }}>{vid.views} views · {vid.date}</span>
                                    </div>
                                </a>
                            ))}
                        </div>
                                    ...
                                    {section.articles.map(art => (
                                        <a key={art.id} href={art.url || "#"} style={{ ...CARD_BASE, flexShrink: 0, width: "calc(33.333% - 11px)", minWidth: "260px" }} onMouseEnter={onEnter} onMouseLeave={onLeave}>
                                            ...
                                            <div style={{ padding: "12px 14px 16px" }}>
                                                ...
                                                <span style={{ fontSize: "12px", color: "var(--pulse-color-text-muted)" }}>{art.author} · {art.date}</span>
                                            </div>
                                        </a>
                                    ))}
                                </div>
